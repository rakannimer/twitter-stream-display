...
//require('materialize-css/dist/js/materialize2');
...
Toast.log('toast initiated','success');
...
tweet_stream = new TweetStream();

var storage = require('./lib/storage');
var CodeEditor = require('./lib/CodeEditor');
...
// 		$("#stream_toggle").on('click', {context: this}, function() {
// 			tweet_stream.toggle.call(tweet_stream);
// 		});
// 		$("#heatmap_toggle").on('click', function(){ 
// 			map.heatmap_toggle.call(map);
// 		});
// 		$("#markers_toggle").on('click', function() {
// 			map.markers_toggle.call(map);
// 		});
